...
protected:
  ...
  DynObjFilterWrapper::Ptr dyn_filter_;
  ...
  BASIC::CloudPtr dyn_cloud_world_, steady_cloud_world_;
  int frame_num_ = 0;
  ...
  alignas(64) bool effect_mask_[200000] = {false};
  alignas(64) bool effect_knn_mask_[200000] = {false};
