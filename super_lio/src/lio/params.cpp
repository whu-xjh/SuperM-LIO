...
namespace LI2Sup{
  ...
  /// pose output
  bool g_pose_output_en = false;
  std::string g_seq_name = "trajectory";
  std::string g_pose_output_dir = "/home/wsl-4080/code/traj_evo/pred/super-lio";
